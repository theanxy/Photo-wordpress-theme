...
<ul>
  ...
  <!-- get most recent tweet; this uses a version of the "twitter messages" plugin http://rick.jinlabs.com/code/twitter/ that                  I've amended to remove the potentially inaccessible hCalendar microformat -->
  <h2>Right now&hellip;</h2>
  <p>
    <?php twitter_messages("brucel");   ?>
  </p>
